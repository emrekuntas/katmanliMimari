$(function () {
    ...
    //Dollar Money
    $demoMaskedInput.find('.money-dollar').inputmask('99999', { placeholder: '_____.__Tl' });
    //tl money
    $demoMaskedInput.find('.tl-money').inputmask("99999.99");
   
    //tc kimlik
    $demoMaskedInput.find(".tckimlik").inputmask('99999999999', { placeholder: '___________' });
    ...
    //iban
    $demoMaskedInput.find('.hesapNo').inputmask('9999 9999 9999 9999', { placeholder: '____ ____ ____ ____' });

    //hesap no
    $demoMaskedInput.find('.iban').inputmask('TR 9999 9999 9999 9999 9999 9999', { placeholder: ' ____ ____ ____ ____ ____ ____' });
